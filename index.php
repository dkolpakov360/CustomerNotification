...
$user1 = new User('Маша', 'masha@email.ru', 'woman', 18);
$user2 = new User('Саша', 'sasha@email.ru', 'man', 16, 89151264869);
$user3 = new User('Вася', 'vasya@email.ru', 'man', 17, 89261434567);

$user1->notify('What the fuck?');
$user2->notify('Why this bullshit happen again?');
$user3->notify('This game is sucks');